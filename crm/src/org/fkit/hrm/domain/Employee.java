...
public class Employee implements java.io.Serializable
{
    ...
    /**
     * 使用@ModelAttribute接收参数时 form表单中有日期,Spring不知道该如何转换, 要在实体类的日期属性上加@DateTimeFormat(pattern="yyyy-MM-dd")注解
     */
    ...
    public String toString()
    {
        return "Employee [id=" + id + ", dept=" + dept + ", job=" + job + ", name=" + name + ", cardId=" + cardId
            ...
            + qqNum + ", email=" + email + ", sex=" + sex + ", party=" + party + ", birthday=" + birthday + ", race="
            + race + ", education=" + education + ", speciality=" + speciality + ", hobby=" + hobby + ", remark="
